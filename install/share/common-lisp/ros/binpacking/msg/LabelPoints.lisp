...
(cl:defclass <LabelPoints> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector binpacking-msg:LabelPoint)
   :initform (cl:make-array 0 :element-type 'binpacking-msg:LabelPoint :initial-element (cl:make-instance 'binpacking-msg:LabelPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LabelPoints>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LabelPoints)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name binpacking-msg:<LabelPoints> is deprecated: use binpacking-msg:LabelPoints instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <LabelPoints>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader binpacking-msg:points-val is deprecated.  Use binpacking-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LabelPoints>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'binpacking-msg:LabelPoint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LabelPoints>)))
  ...
  (cl:format cl:nil "LabelPoint[] points~%================================================================================~%MSG: binpacking/LabelPoint~%float32 x~%float32 y~%float32 z~%string entityName~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LabelPoints)))
  "Returns full string definition for message of type 'LabelPoints"
  (cl:format cl:nil "LabelPoint[] points~%================================================================================~%MSG: binpacking/LabelPoint~%float32 x~%float32 y~%float32 z~%string entityName~%~%"))
